<template>
    <v-dialog v-model="active" transition="dialog-bottom-transition">
        <v-card>
            <v-form
                @submit.prevent="changeShare"
...
const form = useForm({
    ...
    permission: {
        permission: props.detail.user.permission.name,
        id: props.detail.user.permission.permission_id
    },
