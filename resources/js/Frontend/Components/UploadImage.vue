...
<template>
    <v-dialog transition="dialog-bottom-transition" v-model="model">
        <v-card class="d-flex ga-2 rounded-xl py-2">
            <v-card-actions class="justify-end">
                <v-btn @click="closed" variant="plain" icon="mdi-window-close">
                </v-btn>
            </v-card-actions>
            <v-toolbar
                color="primary"
