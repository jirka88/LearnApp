    ...
    <component :is="DashboardLayout">
        <div class="chapterBg">
            <v-container class="py-12">
                <div
                    class="chapter elevation-20"
                    :class="$vuetify.display.smAndDown ? 'pa-6' : 'pa-10'"
                >
                    <div class="d-flex ga-8 pb-4 overflow-auto">
                        <ChapterSettings :chapter="chapter" :slug="slug">
                        </ChapterSettings>
                        <ExportBtns
                            :showExport="['pdf']"
                    ...
                    <v-divider></v-divider>
                    <p class="text-h2 py-4 font-weight-bold">
                        {{ chapter.name }}
                    </p>
...
const exportFile = async (value) => {
    ...
    await axios
        .post(
            `/dashboard/manager/subject/${props.slug}/chapter/${props.chapter.slug}/export?export=${value}`,
            {},
            {
                responseType: 'blob'
            }
