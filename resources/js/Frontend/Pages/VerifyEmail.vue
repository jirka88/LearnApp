        ...
        <v-container class="px-4 d-flex justify-center align-center vh-calc">
            ...
            >
                ...
                <p class="text-h4 font-weight-bold">
                    Ověřte svojí emailovou adresu
                </p>
                <p class="py-6">
                    Zaslali jsme Vám odkaz na email
                    <span class="font-weight-bold">{{
                        $page.props.user.email
                    }}</span>
                </p>
                <p>
                    Klikněte na link v emailu pro ověření Vaší emailové adresy.
                </p>
                <p>Zkontrolujte popřípadně spam složku.</p>
                <p class="text-subtitle-2 pt-4">
                    Nepřišel Vám email? Zkuste ho znovu odeslat.
                </p>
                ...
                <p
                    class="text-subtitle-2 text-center pt-4 text-green"
                    v-if="message"
                >
                    {{ $t(message) }}
                </p>
