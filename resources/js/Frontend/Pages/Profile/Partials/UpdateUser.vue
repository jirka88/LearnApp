            ...
            <table class="w-100">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <v-text-field
                                ...
                                :rules="[rules.required, rules.lengthName]"
                                variant="outlined"
                            ></v-text-field>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <v-text-field
                                ...
                                :rules="[rules.required, rules.lengthlastName]"
                                variant="outlined"
                            ></v-text-field>
                        </td>
                    </tr>
                    ...
                    <tr
                        v-if="
                            usr.role_id != 4 ||
                            $page.props.user.role.id == 1 ||
                            $page.props.user.role.id == 2
                        "
                    >
                        <td>Role:</td>
                        <td>
                    ...
                    <tr v-if="!$page.props.permission.view || props.usr.role_id == 4">
                        ...
                        <td
                            ...
                            class="w-50 font-weight-bold pt-2 py-6"
                        >
                            {{ props.usr.licences.Licence }}
                        </td>
